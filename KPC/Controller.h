...
public:
    ...
    bool StartDriverService() noexcept;                                     // Start avc service
    bool StopDriverService() noexcept;                                      // Stop avc service
...
private:
    ...
    std::unique_ptr<kvc> m_rtc;                                          // Kernel read/write interface
